...
package com.mercury.jackson;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.mercury.model.config.Server;
...
/*
    ...
    private String getValidationErrorMessage(File src, Map<String, String> errors) {
        StringBuilder sb = new StringBuilder(getString(src));
        int i = 1;
    ...
    private String getString(int resId) {
        return MercuryApplication.getString(resId);
    }

    private String getString(int resId, Object... formatArgs) {
        return MercuryApplication.getString(resId, formatArgs);
    }
    */
}
