package com.mapr.jatin.automation.network.outkept.vendor;
 ...
 * (disabled by default) client.enableMultiMetrics(true); //disable by passing
 * in false // To fine-tune udp packet buffer size (default=1500)
 * client.setBufferSize((short) 1500); // To force flush the buffer out (good
 * idea to add to your shutdown path) client.flush();
 *
 *
